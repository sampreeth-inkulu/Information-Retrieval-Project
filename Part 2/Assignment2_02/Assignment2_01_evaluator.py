...
if __name__ == "__main__":
    ...
    with open(file_name, 'w') as result_file:
        ...
        writer.writerow(["", avg_ap10, avg_ap20, avg_ndcg10, avg_ndcg20])
    
    print("\nResults are stored in", file_name, "where each row indicates Query id, Average Precision@10, Average Precision@20, NDCG@10, NDCG@20 respectively and last row indicates the average values with query_id as empty.") 
    print("Done!")